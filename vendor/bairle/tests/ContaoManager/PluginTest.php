...
namespace Bairle\ContaoBairleStellenangeboteBundle\Tests\ContaoManager;

use Contao\CoreBundle\ContaoCoreBundle;
use Contao\ManagerPlugin\Bundle\Config\BundleConfig;
use Contao\ManagerPlugin\Bundle\Parser\DelegatingParser;
use Contao\TestCase\ContaoTestCase;
use Bairle\ContaoBairleStellenangeboteBundle\ContaoManager\Plugin;
...
class PluginTest extends ContaoTestCase
{
    ...
    public function testGetBundles(): void
    {
        ...
        $this->assertSame(BairleContaoBairleStellenangeboteBundle::class, $bundles[0]->getName());
